        ...
        <table class="table-fixed border-separate border-spacing-y-0 border-spacing-x-0">
          ...
          <tbody>
            <tr v-for="monster in level.monsters" :key="monster.displayName">
              <td class="border-b border-black pb-1 pt-2 pr-2">{{ monster.displayName }}</td>
              <td class="border-b border-black pb-1 pt-2 pr-2">
                <LevelMonster
                  :res="monster.physRes"
                  :dmg="physDmg"
              ...
              <td class="border-b border-black pb-2 pt-2 pr-2">
                <LevelMonster
